...
corner.corner(samples,labels=['Teff', 'log g', '[M/H]'],quantiles=[0.16, 0.5, 0.84], show_titles=True, title_kwargs={"fontsize": 12}, range=[(3800,4200),(4.0,5.5),(-2.5,0)])
...
fig.savefig(f'chains.png',dpi=500,facecolor='white')