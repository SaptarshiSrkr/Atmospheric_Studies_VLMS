...
for file in os.listdir('../Data/SYNTHETIC/Raw_Abun/'):
    filename = os.fsdecode(file)
     
    if filename.endswith(".7"): 
         
        df = pd.read_csv(f'../Data/SYNTHETIC/Raw_Abun/{filename}',usecols=[0, 1],names=['wave','flux'],sep='\s+',low_memory=False)
        ...
        norm_df.to_csv(f'../Data/SYNTHETIC/Normalized_Abun/norm_{filename}.txt',sep='\t',index=False,header=False)
